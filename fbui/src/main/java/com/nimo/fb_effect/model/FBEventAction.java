...
public class FBEventAction {
  ...
  //切换面板
  public static final String ACTION_CHANGE_PANEL = "ACTION_CHANGE_PANEL";

  //同步滑动条
  public static final String ACTION_SYNC_PROGRESS = "ACTION_SYNC_PROGRESS";
  ...
  public static final String ACTION_SHOW_WATERMARK_ITEM = "ACTION_SHOW_WATERMARK_ITEM";
  public static final String ACTION_SHOW_WATERMARK_TAKEPHOTO = "ACTION_SHOW_WATERMARK_TAKEPHOTO";
  ...
  //更新滤镜类型
  public static final String ACTION_SHOW_FILTER = "ACTION_SHOW_FILTER";
