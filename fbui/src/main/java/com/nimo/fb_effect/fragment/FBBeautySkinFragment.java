...
public class FBBeautySkinFragment extends FBBaseLazyFragment {
  ...
  private FBSkinItem btnsharpening;
  ...
  private FBSkinItem btnWhiteBalance;
  private FBSkinItem btnSharpFeatured;
  ...
  @Override protected void initView(
    ...
    btnsharpening = findViewById(R.id.btn_sharpening);
    btnsharpening.init(FBBeauty.sharpening);
    ...
    btnWhiteBalance = findViewById(R.id.btn_whitebalance);
    btnWhiteBalance.init(FBBeauty.whitebalance);
    btnSharpFeatured = findViewById(R.id.btn_sharpfeatured);
    btnSharpFeatured.init(FBBeauty.sharpfeatured);
