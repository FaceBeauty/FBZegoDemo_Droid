...
import im.zego.advancedvideoprocessing.CustomerVideoCapture.aveencoder.AVCEncoder;
...
public class VideoCaptureFromCamera3 extends ZegoVideoCaptureCallback implements Camera.PreviewCallback, TextureView.SurfaceTextureListener {
    ...
    public void onStart(ZegoPublishChannel channel) {
        ...
        if (mAVCEncoder == null) {
            ...
            if (!isSupport) {
                ...
                Toast.makeText(context, "The current device does not support encoding I420 data, " +
                        "please try another device", Toast.LENGTH_LONG).show();
                return;
            }
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        if (mAVCEncoder != null) {
            ...
            AVCEncoder.TransferInfo transferInfo = mAVCEncoder.outputFrameFromEncoder();
            if (transferInfo != null) {
                ...
                zegoVideoEncodedFrameParam.format = ZegoVideoEncodedFrameFormat.AnnexB;
                ...
                if (mFront==Camera.CameraInfo.CAMERA_FACING_FRONT) {
                    zegoVideoEncodedFrameParam.rotation = 90;
                ...
                zegoExpressEngine.sendCustomVideoCaptureEncodedData(mEncodedBuffer, transferInfo.inOutData.length, zegoVideoEncodedFrameParam, transferInfo.timeStmp, mChannel);
            }
        }
