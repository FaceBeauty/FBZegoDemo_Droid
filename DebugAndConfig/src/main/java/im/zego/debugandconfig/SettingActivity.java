...
public class SettingActivity extends AppCompatActivity {
    ...
    public void bindView(){
        ...
        configEditText = findViewById(R.id.engineConfig);
    }
    ...
    public void setDefaultValue() {
        ...
        configEditText.setText(engineConfig);
    }
    ...
    public void setSaveButtonEvent(){
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                engineConfig = configEditText.getText().toString();
                String[] configKV = engineConfig.split("=");
                if (configKV.length == 2)
                {
                    ZegoEngineConfig config = new ZegoEngineConfig();
                    HashMap<String, String> advanceConfig = new HashMap<>();
                    advanceConfig.put(configKV[0], configKV[1]);
                    config.advancedConfig = advanceConfig;
                    ZegoExpressEngine.setEngineConfig(config);
                    AppLogger.getInstance().callApi("setEngineConfig %s:%s", configKV[0], configKV[1]);
                }
            }
        });
    }
