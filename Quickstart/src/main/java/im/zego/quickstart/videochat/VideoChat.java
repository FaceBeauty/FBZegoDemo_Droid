...
public class VideoChat extends AppCompatActivity {
    ...
    protected void onDestroy() {
        ...
        ZegoExpressEngine.destroyEngine(new IZegoDestroyCompletionCallback() {
            @Override public void onDestroyCompletion() {
    ...
    public void setEventHandler() {
        engine.setEventHandler(new IZegoEventHandler() {
            ...
            public void onRoomStateChanged(String roomID, ZegoRoomStateChangedReason reason, int errorCode, JSONObject extendedData) {
                AppLogger.getInstance().receiveCallback("onRoomStateChanged, roomID:%s, reason:%s, errorCode:%d", roomID, reason.toString(), errorCode);
