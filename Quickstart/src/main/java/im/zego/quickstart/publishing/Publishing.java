package im.zego.quickstart.publishing;
...
public class Publishing extends AppCompatActivity {
    ...
    public void bindView(){
        ...
        publishNotes = findViewById(R.id.publishNotes);
        publishNotes.setMovementMethod(LinkMovementMethod.getInstance());
    }
...
//                AppLogger.getInstance().receiveCallback("onPublisherSendAudioFirstFrame. channel:%s", channel);
//            }
