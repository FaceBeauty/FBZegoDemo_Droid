package im.zego.others.beautyandwatermarkandsnapshot;
...
public class BeautyWatermarkSnapshotActivity extends AppCompatActivity {
    ...
    Switch watermarkButton;
    Button watermarkFile;
    Switch isPreviewVisibleButton;
    ...
    private void saveScreenShot(Bitmap bitmap)  {
        if (bitmap != null) {
            ...
            ZegoFileUtil.saveBitmap(filename, bitmap, getApplicationContext());
        } else {
