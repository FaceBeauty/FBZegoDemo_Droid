...
public class MultiVideoSourceActivity extends AppCompatActivity {
    ...
    private void initData() {
        copyAssetsFiles();
        mainScreenCaptureConfig.captureVideo = false;
        mainScreenCaptureConfig.captureAudio = false;
        auxScreenCaptureConfig.captureVideo = false;
        auxScreenCaptureConfig.captureAudio = false;
    }
            ...
            public void onClick(View v) {
                ...
                if (isMainPublish){
                    ...
                    if (mainCurrentVideoSourceType == ZegoVideoSourceType.SCREEN_CAPTURE) {
                        mainScreenCaptureConfig.captureVideo = mainCurrentVideoSourceType == ZegoVideoSourceType.SCREEN_CAPTURE;
                        mainScreenCaptureConfig.captureAudio = mainCurrentAudioSourceType == ZegoAudioSourceType.SCREEN_CAPTURE;
            ...
            public void onClick(View view) {
                ...
                if (isAuxPublish){
                    ...
                    if (auxCurrentVideoSourceType == ZegoVideoSourceType.SCREEN_CAPTURE) {
                        auxScreenCaptureConfig.captureVideo = auxCurrentVideoSourceType == ZegoVideoSourceType.SCREEN_CAPTURE;
                        auxScreenCaptureConfig.captureAudio = auxCurrentAudioSourceType == ZegoAudioSourceType.SCREEN_CAPTURE;
        ...
        auxVideoSourceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!isAuxPublish) {
                    ...
                    if (engine != null) {
                        if (auxCurrentVideoSourceType != ZegoVideoSourceType.PLAYER && mediaPlayer != null) {
    ...
    void mainSwitchAudioSource(ZegoAudioSourceType audioSourceType) {
        ...
        switch (mainCurrentAudioSourceType) {
            case CUSTOM:
                ...
                break;
            case SCREEN_CAPTURE:
                mainScreenCaptureConfig.captureAudio = true;
                engine.updateScreenCaptureConfig(mainScreenCaptureConfig);
    ...
    void auxSwitchAudioSource(ZegoAudioSourceType audioSourceType) {
        ...
        switch (auxCurrentAudioSourceType) {
            ...
            case SCREEN_CAPTURE:
                auxScreenCaptureConfig.captureAudio = true;
                engine.updateScreenCaptureConfig(auxScreenCaptureConfig);
