...
import im.zego.others.aivoicechanger.AIVoiceChanger;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //todo --- fbEffect start
        FBEffect.shareInstance().initFaceBeauty(this, "YOUR_APP_ID", new FBEffect.InitCallback() {
            @Override public void onInitSuccess() {
                Log.d(TAG, "onInitSuccess:初始化成功 ");
            }

            @Override public void onInitFailure() {
                Log.d(TAG, "onInitFailure: 初始化成功");
        ...
        mainAdapter.setOnItemClickListener((view, position) -> {
            ...
            if (orRequestPermission) {
                ...
                }else if (module.equals(getString(R.string.ai_voice_changer))) {
                    AIVoiceChanger.actionStart(MainActivity.this);
                }
            }
        });
...
//        mainAdapter.addModuleInfo(new ModuleInfo().moduleName(getString(R.string.low_latency_live)));
        ...
        mainAdapter.addModuleInfo(new ModuleInfo().moduleName(getString(R.string.ai_voice_changer)));
