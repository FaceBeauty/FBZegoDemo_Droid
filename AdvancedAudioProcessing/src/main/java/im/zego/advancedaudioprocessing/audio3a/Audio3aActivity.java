            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (options[position]){
                    ...
                    case "AI_BALANCED":
                        ...
                        AppLogger.getInstance().callApi("SET AEC mode: AI_BALANCED");
                        break;
                    case "AI_LOW_LATENCY":
                        engine.setANSMode(ZegoANSMode.AI_LOW_LATENCY);
                        AppLogger.getInstance().callApi("SET AEC mode: AI_LOW_LATENCY");
                        break;
                }
            }
