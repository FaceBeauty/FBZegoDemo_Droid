...
public class RangeAudioActivity extends AppCompatActivity {
    ...
    public  boolean isEffectiveValue(String ss, boolean check_min_max, int minValue,int maxvalue)
    {
        if(ss.isEmpty())
            return false;
    ...
    public void setViewEventListener() {
        ...
        frontValueSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                selfPosition[0] = seekBar.getProgress() + positionOffset;
                rangeAudio.updateSelfPosition(selfPosition, matrixRotateFront, matrixRotateRight, matrixRotateUp);
                ...
                frontValueTextView.setText(String.valueOf((int)selfPosition[0]));
            }
        });
        ...
        rightValueSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                selfPosition[1] = seekBar.getProgress() + positionOffset;
                rangeAudio.updateSelfPosition(selfPosition, matrixRotateFront, matrixRotateRight, matrixRotateUp);
                ...
                rightValueTextView.setText(String.valueOf((int)selfPosition[1]));
            }
        });
        ...
        upValueSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                selfPosition[2] = seekBar.getProgress() + positionOffset;
                rangeAudio.updateSelfPosition(selfPosition, matrixRotateFront, matrixRotateRight, matrixRotateUp);
                ...
                upValueTextView.setText(String.valueOf((int)selfPosition[2]));
            }
        });
        ...
        frontRotateSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                int realProgress = seekBar.getProgress() + rotationOffset;
                rotateAngles[0] = (float) (realProgress * Math.PI / 180);
                eulerAnglesToRotationMatrix(rotateAngles, matrixRotateFront, matrixRotateRight, matrixRotateUp);
                // Update self position
                rangeAudio.updateSelfPosition(selfPosition, matrixRotateFront, matrixRotateRight, matrixRotateUp);

                AppLogger.getInstance().callApi("Update front rotate:%d", realProgress);

                frontRotateTextView.setText(String.valueOf(realProgress));
            }
        });
        ...
        rightRotateSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                int realProgress = seekBar.getProgress() + rotationOffset;
                rotateAngles[1] = (float) (realProgress * Math.PI / 180);
                eulerAnglesToRotationMatrix(rotateAngles, matrixRotateFront, matrixRotateRight, matrixRotateUp);
                // Update self position
                rangeAudio.updateSelfPosition(selfPosition, matrixRotateFront, matrixRotateRight, matrixRotateUp);

                AppLogger.getInstance().callApi("Update right rotate:%d", realProgress);

                rightRotateTextView.setText(String.valueOf(realProgress));
            }
        });
        ...
        upRotateSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                int realProgress = seekBar.getProgress() + rotationOffset;
                rotateAngles[2] = (float) (realProgress * Math.PI / 180);
                eulerAnglesToRotationMatrix(rotateAngles, matrixRotateFront, matrixRotateRight, matrixRotateUp);
                // Update self position
                rangeAudio.updateSelfPosition(selfPosition, matrixRotateFront, matrixRotateRight, matrixRotateUp);

                AppLogger.getInstance().callApi("Update up rotate:%d", realProgress);

                upRotateTextView.setText(String.valueOf(realProgress));
            }
        });
        ...
        mediaPlayerLoadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isEffectiveValue(editMediaPlayerIndex.getText().toString(),true,0,3))
                    return;
                if(!isEffectiveValue(editMediaResourceIndex.getText().toString(),true,0,4))
                    return;
        ...
        mediaPlayerFrontSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                int value = seekBar.getProgress() + positionOffset;
        ...
        audioEffectPlayerStartButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String  streffectSoundID = editEffectSoundID.getText().toString();
                String  strAudioResourceIndex = editAudioResourceIndex.getText().toString();
                if(!isEffectiveValue(streffectSoundID, false, 0, 0))
                    return;

                if(!isEffectiveValue(strAudioResourceIndex, true, 0, 1))
                    return;

                int effectSoundID = Integer.parseInt(streffectSoundID);
                int resourceIndex = Integer.parseInt(strAudioResourceIndex);
        ...
        audioEffectPlayerStopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isEffectiveValue(editEffectSoundID.getText().toString(), false, 0, 0))
                    return;
